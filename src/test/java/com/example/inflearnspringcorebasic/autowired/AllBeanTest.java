package com.example.inflearnspringcorebasic.autowired;
...
public class AllBeanTest {
    ...
    @Test
    void findAllBean() {
        final AnnotationConfigApplicationContext ac = new AnnotationConfigApplicationContext(AutoAppConfig.class, DiscountService.class);
